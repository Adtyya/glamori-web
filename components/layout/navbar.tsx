                ...
                return (
                  <li role="none" className="flex items-stretch" key={i}>
                    <Link
                      role="menuitem"
                      aria-haspopup="false"
                      className={`flex items-center gap-2 py-2 transition-colors duration-300 hover:text-glamorig-500 focus:text-glamorig-500 focus:outline-none focus-visible:outline-none lg:px-5 ${
                        path === r.path ? "text-glamorig-500" : ""
                      }`}
                      href={r.path}
                    >
                      <span>{r.name}</span>
