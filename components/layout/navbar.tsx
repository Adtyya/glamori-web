  ...
  return (
    <>
      ...
      <header className="relative z-20 w-full border-b shadow-lg border-slate-200 bg-white/90 shadow-slate-700/5 after:absolute after:left-0 after:top-full after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative max-w-full px-6 mx-auto lg:max-w-5xl xl:max-w-7xl">
          <nav
          ...
          >
            ...
            <ul
              ...
              className={`absolute left-0 top-0 z-[-1] scroll-none h-[20.5rem] w-full justify-center overflow-hidden  overflow-y-auto overscroll-contain bg-white/90 px-8 pb-12 pt-24 font-medium transition-[opacity,visibility] duration-300 lg:visible lg:relative lg:top-0  lg:z-0 lg:flex lg:h-full lg:w-auto lg:items-stretch lg:overflow-visible lg:bg-white/0 lg:px-0 lg:py-0  lg:pt-0 lg:opacity-100 ${isToggleOpen
                ...
                return (
                  <li role="none" className="flex items-stretch" key={i}>
                    <Link
                      role="menuitem"
                      aria-haspopup="false"
                      className={`flex items-center gap-2 py-2 transition-colors duration-300 hover:text-glamorig-500 focus:text-glamorig-500 focus:outline-none focus-visible:outline-none lg:px-5 ${path === r.path ? "text-glamorig-500" : ""
                        }`}
                      href={r.path}
                    >
                      <span>{r.name}</span>
