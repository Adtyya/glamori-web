  ...
  return (
    <Container>
      <div className="py-12">
        ...
        <div
          id="location-1"
          className="grid w-full grid-cols-1 gap-6 mb-16 lg:grid-cols-2"
        >
          <div className="space-y-4">
            <Heading as={3} className="capitalize text-start">
              Glamori cabang jakarta
            </Heading>
            <Paragraph size="lg" className="text-justify text-gray-600">
            ...
            <div className="relative w-full h-64 mt-6 overflow-hidden border border-gray-200 rounded-lg shadow-md md:h-96">
              <Image
                alt="jakarta_branch"
          ...
          <div className="overflow-hidden border border-gray-200 rounded-lg shadow-md">
            <iframe
              ...
              className="w-full h-64 border-none lg:h-full"
            ></iframe>
          </div>
        </div>
