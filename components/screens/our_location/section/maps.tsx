  ...
  return (
    <Container>
      <div className="py-12">
        ...
        <div id="location-1" className="space-y-3.5 w-full">
          <Heading as={3} className="capitalize text-start">
            Glamori cabang jakarta
          </Heading>
          <Paragraph size="lg" className="text-justify">
            Jl. Muara Karang Bar., RT.1/RW.2, Pluit, Kecamatan Penjaringan, Jkt
            Utara, Daerah Khusus Ibukota Jakarta 14450, Indonesia
          </Paragraph>
          <iframe
        ...
        <br />
        <div id="location-2" className="space-y-3.5 w-full">
          <Heading as={3} className="capitalize text-start">
